...
public class Frame_Test extends javax.swing.JFrame {
    ...
    public Frame_Test() {
     ...
     public Frame_Test(Pompier s){
        initComponents();
        jlbl_prenom.setText(s.getPrenom());
        jlbl_nom.setText(s.getNom());
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jlbl_prenom, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, -1, -1));
        getContentPane().add(jlbl_nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 40, -1, -1));
