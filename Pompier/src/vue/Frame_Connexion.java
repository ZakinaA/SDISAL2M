...
public class Frame_Connexion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpnl_fond2.add(jlbl_logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, 240, 280));
        jpnl_fond2.add(jlbl_msgErreur, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, -1, -1));

        getContentPane().add(jpnl_fond2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 360, 450));
        ...
        getContentPane().add(jpnl_fond1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 420, 450));

        setSize(new java.awt.Dimension(789, 485));
    ...
    private void jbtn_validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_validerActionPerformed
        ...
        try {
            ...
            if(leCompte != null){
                ...
                if(responsable == 0){
                    Pompier p = PompierDAO.getPompier(cnt, leCompte.getLogin(), leCompte.getMdp());
                    leMenu = new Frame_PompAccueil(p);
                }
                else if (responsable==1){
                    Pompier s= PompierDAO.getPompier(cnt , leCompte.getLogin(), leCompte.getMdp());
                    leMenu = new Frm_Responsable(s);
                }
